...
class Level0:
    def __init__(self):
        self.slides = [
{"image": "intologi/im1.jpeg", "message": "CARL, A TEENAGER FROM NEVADA, STUMBLED UPON DRUGS IN THE STREETS."},
...
{"image": "intologi/im5.jpeg", "message": "AS HIS ADDICTION DEEPENED, CARL'S HEALTH AND WELL-BEING SUFFERED."},
...
{"image": "plain_black.jpeg", "message": ""}
        ...
        self.text_speed = 0.25  # Speed of text rendering (in seconds per letter)
